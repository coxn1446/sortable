...
function iconWrapper(viewBoxChild, props) {
  const { className = 'h-5 w-5 shrink-0', title, ...rest } = props;
  return (
    <svg
...
export function IconActivity(props) {
  return iconWrapper(<path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z" />, props);
}
